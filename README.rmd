...
Once potential habitat and inhabitable areas are compiled, total area of each are calculated to provide a means of stratifying moose survey blocks into categories of Low, Medium and High. A table of all calculations is output for the user to review. 
...
Fire  - STILL TO ADD DETAILS 



These ages can be adjusted separately for each disturbance type. 
...
- [fire severity](https://catalogue.data.gov.bc.ca/dataset/fire-burn-severity-same-year) used to estimate the intensity of most recent fires. 


STILL TO ADD DETAILS
