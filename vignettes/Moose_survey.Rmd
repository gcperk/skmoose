...
basedata <- foreach(x = blockno[21:40]) %dopar% {
  
  # test line - if you want to run a single block 
  #x = blockno[42] #42, #50, #38
  print(x)
...
uninhab <- foreach(x = blockno[38:43]) %dopar% {
...
habitable <- foreach(x = blockno[38:43]) %dopar% {
...
burn_strat <- foreach(x = blockno[38:43]) %dopar% {
